...
<div class="row">
        <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-primary" href="{{ route('peminjamanAdmin.create') }}">Tambah Peminjaman</a>
            </div>
            <div class="card-body">  
                    ...
                    <table class="table mb-0"> <!-- table mb-0-->
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary col-9" href="{{ route('peminjamanAdmin.show', $peminjaman->id) }}">Detail</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
